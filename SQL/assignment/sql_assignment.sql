...
insert into programmer values('susi', '1969-09-09',  '1992-05-02','f','java','react','7000');
...
insert into software values('suci', 'bmi',  'pascal',378.95,6900,43);
insert into software values('Deepan', 'cal',  'c',45600.78,9000,63);
insert into software values('Ramesh', 'todo',  'c',399.95,6000,49);
insert into software values('suchi', 'suchhi',  'pascal',379.95,8900,43);
...
insert into studies values('susi','cbe','embedded',9900);
